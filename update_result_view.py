...
# Extract everything from @Composable fun ResultView to the end
result_view_pattern = re.compile(r"@Composable\s+fun ResultView\(.*?}\s*}\s*}$", re.MULTILINE | re.DOTALL)
...
new_content = result_view_pattern.sub(new_result_view, content)

# Also ensure we have the necessary imports
if "import androidx.compose.material.icons.filled.Edit" not in new_content:
    new_content = new_content.replace("import androidx.compose.material.icons.Icons", "import androidx.compose.material.icons.Icons\nimport androidx.compose.material.icons.filled.Edit")

if "import androidx.compose.material3.OutlinedTextField" not in new_content:
